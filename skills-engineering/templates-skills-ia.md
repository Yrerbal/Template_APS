...
|---------------|----------|-------------|------------------------------------|
| [param_1]     | texte    | oui         | [description courte]               |
| [param_2]     | liste    | non         | [description courte, valeur défaut]|
...
|---|---|---|
| Skill trop large ("répond à tout") | Imprévisible, non testable | Découper en skills atomiques |
